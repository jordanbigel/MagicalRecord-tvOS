...
+ (void) setupCoreDataStackWithInMemoryStoreNamed:(NSString*)storeName
{
    if ([NSPersistentStoreCoordinator MR_defaultStoreCoordinatorWithStoreName:storeName] != nil) return;
...
+ (void) setupCoreDataStackWithInMemoryStoreAndSchemaName:(NSString*)name
{
    if ([NSPersistentStoreCoordinator MR_defaultStoreCoordinator] != nil) return;
