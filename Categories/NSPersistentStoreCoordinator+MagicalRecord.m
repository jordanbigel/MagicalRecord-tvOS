...
+ (NSPersistentStoreCoordinator *) MR_defaultStoreCoordinatorWithStoreName:(NSString*)storeName
{
    if (defaultCoordinator_ == nil && [MagicalRecord shouldAutoCreateDefaultPersistentStoreCoordinator])
    {
        [self MR_setDefaultStoreCoordinator:[self MR_newPersistentStoreCoordinatorWithStoreName:storeName]];
    }
    return defaultCoordinator_;
}
...
+ (NSPersistentStoreCoordinator *) MR_newPersistentStoreCoordinatorWithStoreName:(NSString*)storeName
{
    NSPersistentStoreCoordinator *coordinator = [self MR_coordinatorWithSqliteStoreNamed:storeName];
