...
+ (NSString *) MR_entityName;
{
    ...
    /*
    NSString* n2 = [entityName substringFromIndex:2];
    NSRange rng = [n2 rangeOfString:@"MO"];
    NSString* name = [n2 substringToIndex:rng.location];
    entityName = name;
    
    if ([entityName isEqualToString:@"Collection"])
        entityName = @"Issue";
    */
