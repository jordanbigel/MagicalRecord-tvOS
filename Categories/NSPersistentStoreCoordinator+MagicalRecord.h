...
+ (MR_nullable NSPersistentStoreCoordinator *) MR_defaultStoreCoordinatorWithStoreName:(MR_nonnull NSString *)storeName;
...
+ (MR_nonnull NSPersistentStoreCoordinator *) MR_newPersistentStoreCoordinatorWithStoreName:(MR_nonnull NSString *)storeName NS_RETURNS_RETAINED;
